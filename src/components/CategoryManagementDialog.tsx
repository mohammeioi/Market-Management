...
export function CategoryManagementDialog({ open, onOpenChange }: CategoryManagementDialogProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={() => onOpenChange(false)}>
            <div
                className="bg-background rounded-2xl shadow-neu w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]"
                ...
                <div className="p-4 border-b border-gray-100">
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-background border-none shadow-neu-inset rounded-xl py-2.5 px-4 pr-10 outline-none focus:ring-2 focus:ring-primary/20 transition-all text-sm"
                        />
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2">
                    {filteredCategories.length === 0 ? (
                        ...
                        filteredCategories.map(category => (
                            <div key={category.id} className="flex items-center justify-between p-3 rounded-xl border-none shadow-neu hover:shadow-neu-sm bg-background group transition-all">
